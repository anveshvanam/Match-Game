...
class Home extends Component {
  ...
  updateImage = imageId => {
    this.setState({activeImageId: imageId}, this.checkImage)
  }
  ...
  checkImage = () => {
    ...
    if (activeImageId === selectedImageId) {
      ...
      this.setState({
        selectedImage: newRandomImage.imageUrl,
        selectedImageId: newRandomImage.id,
      })
    } else {
      this.setState({showResults: true})
      this.stopTimer()
  ...
  renderHeader = () => {
    const {secondsLeft, showResults, activeTabId, score} = this.state
      ...
      <div className="header-container">
        ...
        <div className="score-time-container">
          ...
          <ul className="time-container">
            ...
            <li>
              <p className="para">{secondsLeft} sec</p>
            </li>
          </ul>
        </div>
      </div>
  ...
  renderGame = () => {
    const {activeTabId, selectedImage} = this.state
    ...
    return (
      <div className="game-container">
        <img src={selectedImage} alt="match" className="random-image" />
  ...
  renderRandomImage = () => {
    ...
    this.setState({randomImage: randomImageItem.imageUrl})
  }
  ...
  render() {
    ...
    return (
      <div className="app-container">
        {this.renderHeader()}
        {showResults ? this.renderScoreCard() : this.renderGame()}
      </div>
    )
  }
}
